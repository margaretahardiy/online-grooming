                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Welcome,</strong> insert your dog information here!</h1>
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="" method="POST" class="/insert-dog" enctype="multipart/form-data">
			                    	<div class="form-group">
                                        ...
                                        <h4>Name</h4>
			                        	<input type="text" name="name" class="form-username form-control" id="form-username">
			                        </div>
			                        <div class="form-group">
			                        	<label class="sr-only" for="form-password">Breed</label>
                                         <h4>Breed</h4>
			                        	<input type="text" name="breed" class="form-password form-control" id="form-password"> 
			                        </div>
			                         <div class="form-group">
